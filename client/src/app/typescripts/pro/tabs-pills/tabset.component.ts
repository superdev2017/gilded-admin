...
export class TabsetComponent implements OnDestroy, OnInit {
  ...
  @Output() showBsTab: EventEmitter<any> = new EventEmitter<any>();
  @Output() shownBsTab: EventEmitter<any> = new EventEmitter<any>();
  @Output() hideBsTab: EventEmitter<any> = new EventEmitter<any>();
  @Output() hiddenBsTab: EventEmitter<any> = new EventEmitter<any>();
